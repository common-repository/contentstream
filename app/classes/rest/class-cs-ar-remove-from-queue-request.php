...
/**
 * The class that handles the request data and response for the remove from queue REST route for contentstream.
 ...
 */
class csARRemoveFromQueueRequest extends csARRestRequest
{
    private $feed_id;
     ...
     */
    public function __construct($config_id, $access_token, $feed_id, $uid, $title)
    {
    ...
    /**
     * The getter function of the private var title
     *
     * @return String the title (i.e. the title of the article)
     */
    ...
    /**
     * The setter function of the private var title
     *
     * @param [String] $title  The value the title should be set to
     * @return void
     */
     ...
     *
     * @return String  The completed URL string for the removeFromQueue REST call
     */
    ...
    public function set_response($response)
    {
        ...
        parent::log_request_action(
            csARConfig::REMOVE_FROM_QUEUE_REQUEST_NAME,
            parent::build_string_with_placeholders(
                csARConfig::REMOVE_FROM_QUEUE_REQUEST_SUCCESS_MESSAGE,
